...
from periodic_isdf_benchmarks.parser.parse_inp import parse_octopus_input
...
if __name__ == "__main__":
    ...
    # # Create each job
    # # job_location = "local"  # "remote" is the other option
    ...
    #
    #     # Slurm script
    #     # Consider having one MPI process per
    #     # Change orte run to srun
    #     # Test with ONE file before running all
    #     # Add the parsing to JSON here - Can sort the database later
    #     # Should make the run str more configurable
    #     SlurmConfig(executable = "ADD",
    #                 job_name =
    #                 time =
    #     partition=
    #     nodes =
    ...
    #
    #     cd ${{SLURM_SUBMIT_DIR}}
    #     srun -np $SLURM_NTASKS {self.executable} > {self.stdout}
    #     Extra command to run parsing
    #
    #     """
    #
